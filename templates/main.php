<section class="promo">
    ...
    <ul class="promo__list">
        ...
        <?php if (!empty($cat_mass)) {
            foreach ($cat_mass as $key => $category): ?>
        ...
        <?php foreach ($goods as $good): ?>
            <li class="lots__item lot">
                <div class="lot__image">
                    <img src="<?= htmlspecialchars($good["img"]);?>" width="350" height="260" alt="<?= htmlspecialchars($good["title"]);?>">
                </div>
                <div class="lot__info">
                    ...
                    <div class="lot__state">
                        <div class="lot__rate">
                            ...
                            <span class="lot__cost"><?= format_sum(htmlspecialchars($good["start_price"]));?></span>
                        </div>
                        <?php $res = goods_timer(htmlspecialchars($good["date_finish"])) ?>
